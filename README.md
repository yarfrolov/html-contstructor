...
2. Готово! Приложение работает локально без необходимости установки зависимостей
...
- Данные хранятся локально в браузере. При очистке кэша браузера данные будут удалены
